...
class LoginForm extends Component {
	...
	render() {
		...
		this.loginError = this.props.errorMessage === ""
			? ""
	...
	renderLogin() {
		return (<Card title="כניסה לחשבון" style={{
				width: 300
			}}>
			<Form layout="inline" onSubmit={this.handleSubmit}>
				<FormItem validateStatus={this.userNameError
						? 'error'
						: ''} help={this.userNameError || ''} label="שם משתמש">
					{
				...
				<FormItem validateStatus={this.passwordError
						? 'error'
						: ''} help={this.passwordError || ''} label="סיסמא">
					{
	...
	renderForgotPassword() {
		return (<Card title="איפוס סיסמא" style={{
				width: 300
			}}>
			<Form layout="inline" onSubmit={this.handleEmailSubmit}>
				<FormItem validateStatus={this.userNameError
						? 'error'
						: ''} help={this.userNameError || ''} label="אימייל">
					{
						this.props.form.getFieldDecorator('email', {
							rules: [
								{
	...
	renderCreateNewPassword() {
		return (<Card title="בחירת סיסמא חדשה" style={{
				width: 300
			}}>
